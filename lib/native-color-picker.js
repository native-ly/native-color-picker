...
exports.Gradient = native_1.default(expo_linear_gradient_1.LinearGradient)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  ", "\n\n  z-index: -1;\n\n  ", "\n"], ["\n  ", "\n\n  z-index: -1;\n\n  ",
...
exports.Marker = function (_a) {
    var animate = _a.animate, color = _a.color, size = _a.size, markerStyle = _a.markerStyle, type = _a.type;
    ...
    var opacity = function () {
        ...
        var check = animate && (type === 'checkmark' || type === 'border');
    ...
    var scale = function () {
        ...
        var check = animate === 'scale' && (type === 'checkmark' || type === 'border');
        return {
    ...
    var rotate = function () {
        ...
        var check = animate === 'rotate' && type === 'checkmark';
        return {
            rotate: check
    ...
    return (react_1.default.createElement(Base, null,
        react_1.default.createElement(react_native_1.Animated.View, { style: {
            ...
            } }, type === 'border' ? (react_1.default.createElement(BorderMarker, { color: color, size: size })) : type === 'checkmark' ? (react_1.default.createElement(vector_icons_1.Ionicons, { color: color, name: "md-checkmark", size: (size / 3) * 2 })) : (type === 'fade' && react_1.default.createElement(FadeMarker, { size: size })))));
};
...
var NativeColorPicker = function (_a) {
    var animate = _a.animate, _b = _a.colors, colors = _b === void 0 ? [] : _b, _c = _a.columns, columns = _c === void 0 ? 5 : _c, _d = _a.gradient, gradient = _d === void 0 ? false : _d, _e = _a.horizontal, horizontal = _e === void 0 ? false : _e, _f = _a.itemSize, itemSize = _f === void 0 ? 44 : _f, _g = _a.marker, marker = _g === void 0 ? 'border' : _g, _h = _a.markerStyle, markerStyle = _h === void 0 ? 'contrast' : _h, _j = _a.onSelect, onSelect = _j === void 0 ? function (item) { return item; } : _j, selectedColor = _a.selectedColor, _k = _a.shadow, shadow = _k === void 0 ? false : _k, _l = _a.sort, sort = _l === void 0 ? false : _l, props = __rest(_a, ["animate", "colors", "columns", "gradient", "horizontal", "itemSize", "marker", "markerStyle", "onSelect", "selectedColor", "shadow", "sort"]);
    return (react_1.default.createElement(react_native_1.FlatList, __assign({}, props, { data: sort ? color_sort_1.default(colors) : colors, horizontal: horizontal, keyExtractor: function (index) { return index.toString(); }, numColumns: horizontal ? 1 : columns, renderItem: function (_a) {
            ...
            return (react_1.default.createElement(Item_1.Item, { color: item, itemSize: itemSize, onPress: function () { return onSelect(item); }, shadow: shadow },
                selectedColor === item && (react_1.default.createElement(Marker_1.Marker, { animate: animate, color: item, markerStyle: markerStyle, size: itemSize, type: marker })),
