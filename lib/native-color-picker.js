(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@expo/vector-icons"), require("color-sort"), require("expo"), require("is-dark-color"), require("react"), require("react-native"), require("styled-components/native"));
	else if(typeof define === 'function' && define.amd)
		define("NativeColorPicker", ["@expo/vector-icons", "color-sort", "expo", "is-dark-color", "react", "react-native", "styled-components/native"], factory);
	else if(typeof exports === 'object')
		exports["NativeColorPicker"] = factory(require("@expo/vector-icons"), require("color-sort"), require("expo"), require("is-dark-color"), require("react"), require("react-native"), require("styled-components/native"));
	else
		root["NativeColorPicker"] = factory(root["@expo/vector-icons"], root["color-sort"], root["expo"], root["is-dark-color"], root["react"], root["react-native"], root["styled-components/native"]);
})(global, function(__WEBPACK_EXTERNAL_MODULE__expo_vector_icons__, __WEBPACK_EXTERNAL_MODULE_color_sort__, __WEBPACK_EXTERNAL_MODULE_expo__, __WEBPACK_EXTERNAL_MODULE_is_dark_color__, __WEBPACK_EXTERNAL_MODULE_react__, __WEBPACK_EXTERNAL_MODULE_react_native__, __WEBPACK_EXTERNAL_MODULE_styled_components_native__) {
...
var Color = styled_components_native__WEBPACK_IMPORTED_MODULE_0___default.a.TouchableOpacity(_templateObject(), function (_ref) {
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers */ "./src/helpers/index.tsx");
...
var Base = styled_components_native__WEBPACK_IMPORTED_MODULE_1___default.a.View(_templateObject(), _helpers__WEBPACK_IMPORTED_MODULE_3__["mixin"]);
var BorderMark = styled_components_native__WEBPACK_IMPORTED_MODULE_1___default.a.View(_templateObject2(), _helpers__WEBPACK_IMPORTED_MODULE_3__["mixin"], function (_ref) {
  var color = _ref.color,
      size = _ref.size;
  return "\n    margin: ".concat(Object(_helpers__WEBPACK_IMPORTED_MODULE_3__["countSize"])(size), "px;\n    border-radius: ").concat((size - 2 * Object(_helpers__WEBPACK_IMPORTED_MODULE_3__["countSize"])(size)) / 2, "px;\n    border: ").concat(Object(_helpers__WEBPACK_IMPORTED_MODULE_3__["countSize"])(size), "px solid ").concat(color, ";\n  ");
});
var FadeMark = styled_components_native__WEBPACK_IMPORTED_MODULE_1___default.a.View(_templateObject3(), _helpers__WEBPACK_IMPORTED_MODULE_3__["mixin"], function (_ref2) {
  var size = _ref2.size;
  return "\n    border-radius: ".concat(size / 2, "px;\n  ");
});
...
/*!*******************************!*\
  !*** ./src/helpers/index.tsx ***!
  \*******************************/
/*! exports provided: mixin, countSize */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _mixin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mixin */ "./src/helpers/mixin.tsx");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "mixin", function() { return _mixin__WEBPACK_IMPORTED_MODULE_0__["mixin"]; });
...
/* harmony import */ var is_dark_color__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! is-dark-color */ "is-dark-color");
/* harmony import */ var is_dark_color__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(is_dark_color__WEBPACK_IMPORTED_MODULE_3__);
...
var NativeColorPicker = function NativeColorPicker(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_native__WEBPACK_IMPORTED_MODULE_1__["FlatList"], _extends({}, props, {
    ...
    renderItem: function renderItem(_ref2) {
      ...
      , {
        isDark: is_dark_color__WEBPACK_IMPORTED_MODULE_3___default()(item),
        size: itemSize,
        type: marker
        ...
        colors: is_dark_color__WEBPACK_IMPORTED_MODULE_3___default()(item) ? ['transparent', '#0006'] : ['#fff6', 'transparent'],
        size: itemSize
      }));
    }
  }));
